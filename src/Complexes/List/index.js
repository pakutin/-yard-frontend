  ...
  return (
    <main>
      ...
      <Card
        ...
        description="One Hundred East Fifty Third Street by Foster + Partners is a limited collection of modern residences in Midtown
      ...
      <Card
        ...
        name="152 Elizabeth"
        description="152 Elizabeth is an ultra-luxury condominium building—the first in New York City designed by Japanese master architect
